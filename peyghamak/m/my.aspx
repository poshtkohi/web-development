<%@ Page Language="C#" AutoEventWireup="true" CodeFile="my.aspx.cs" Inherits="Peyghamak.mobile.my"%>
...
<div style="margin-top:12px;"><b><asp:Label ID="MyNameLabel" runat="server"/></b></div>
<form action="my.aspx?mode=post" method="post">
<div style="margin-top:12px;"><input type="text" maxlength="450" id="PostContent" name="PostContent"/></div>
<div style="margin-top:12px;"><input type="submit" value="بفرست"/></div>
</form>
<div style="margin-top:12px;"><a href="my.aspx">خودم</a> | <a href="my.aspx?mode=ShowMyFriendsPosts">دوستان</a> | <a href="my.aspx?mode=ShowPrivateMessages">پیغام خصوصی</a></div>
<div class="m"><br/>
<hr/>
