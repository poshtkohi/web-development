<%@ Page Language="C#" AutoEventWireup="true" CodeFile="message.aspx.cs" Inherits="Peyghamak.mobile.message"%>
...
<div style="margin-top:12px;"><b><asp:Label ID="NameLabel" runat="server"/></b><br/><asp:Label id="Message" runat="server"></asp:Label></div>
<form action="message.aspx?mode=post" method="post">
