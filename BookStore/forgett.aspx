<%@ Page Language="C#" CodeFile="forget.aspx.cs" Inherits="bookstore.forget"%>
...
<div id="skl">
    ...
    <div id="register">
      ...
      <asp:TextBox ID="username" MaxLength="50" runat="server" TextMode="SingleLine"/>
            &nbsp;
            &nbsp;<asp:Button ID="submit" runat="server" Text="بازیابی کن" OnClick="submit_Click" style=" height:20px"/>
        	&nbsp;
        </form>
     </div>               
