<%@ Page Language="C#" AutoEventWireup="true" CodeFile="account.aspx.cs" Inherits="Peyghamak.cp.account" %>
		...
		<div id="left">
			...
			<div id="left_fill">
				...
				<div id="settings_tabs">
					<span class="setting_tab"><a href="password.aspx">کلمه 
					عبور</a></span>
					...
					<span class="setting_tab_right_selected">مشخصات</span></div>
				<div id="settings" style="height: 496px">
					<table border="0" cellpadding="2" cellspacing="2" width="440">
						<tr>
						...
						<tr>
							...
							<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="name" ErrorMessage="نام خالی است." SetFocusOnError="True"></asp:RequiredFieldValidator>
							</td>
							<td align="right">
							<asp:TextBox ID="name" runat="server" lang="fa" MaxLength="50" style="text-align: right"></asp:TextBox>
							</td>
							<td width="10">&nbsp;</td>
							<td align="left" width="225">نام و نام خانوادگی</td>
						</tr>
						<tr>
							<td align="right" dir="rtl" style="width: 289px; height: 20px;">
							<asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="email" ErrorMessage="آدرس ایمیل خالی است." SetFocusOnError="True"></asp:RequiredFieldValidator>
							<asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="email" ErrorMessage="آدرس ایمیل نامعتبر است." SetFocusOnError="True" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"></asp:RegularExpressionValidator>
							</td>
							<td align="right" style="height: 20px">
							<asp:TextBox ID="email" runat="server" MaxLength="50"></asp:TextBox>
							</td>
							<td style="height: 20px"></td>
							<td align="left" style="height: 20px">پیغامک الکترونیکی</td>
						</tr>
						<tr>
							<td align="right" dir="rtl" style="width: 289px">
							<asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="BirthYear" ErrorMessage="*" InitialValue="none" SetFocusOnError="True" Display="Dynamic"></asp:RequiredFieldValidator>
							<asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ControlToValidate="BirthMonth" ErrorMessage="*" InitialValue="none" SetFocusOnError="True" Display="Dynamic"></asp:RequiredFieldValidator>
							<asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ControlToValidate="BirthDay" ErrorMessage="*" InitialValue="none" SetFocusOnError="True" Display="Dynamic"></asp:RequiredFieldValidator>
							</td>
							<td align="right" dir="rtl">&nbsp;<asp:DropDownList ID="BirthYear" runat="server" CssClass="settings_input" ToolTip="سال تولد">
                     <asp:ListItem Value="none">سال</asp:ListItem>
                 		   </asp:DropDownList><asp:DropDownList ID="BirthMonth" runat="server" CssClass="settings_input" ToolTip="ماه تولد">
                     <asp:ListItem Value="none">ماه</asp:ListItem>
                 		   </asp:DropDownList><asp:DropDownList ID="BirthDay" runat="server" CssClass="settings_input" ToolTip="روز تولد">
                     <asp:ListItem Value="none">روز</asp:ListItem>
                 		   </asp:DropDownList></td>
							<td>&nbsp;</td>
							<td align="left">تاریخ تولد</td>
						</tr>
						<tr>
							<td align="right" dir="rtl" style="width: 289px">
							<asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="sex" ErrorMessage="جنسیت خود را انتخاب کنید." InitialValue="none" SetFocusOnError="True"></asp:RequiredFieldValidator>
							</td>
							<td align="right">
							<asp:DropDownList ID="sex" runat="server" CssClass="settings_input">
                     ...
                     <asp:ListItem Value="true">زن</asp:ListItem>
						...
						<tr>
							<td align="right" dir="rtl" style="width: 289px">
							<asp:RequiredFieldValidator ID="RequiredFieldValidator22" runat="server" ControlToValidate="CountryKey" ErrorMessage="کشور خود را انتخاب کنید." InitialValue="none" SetFocusOnError="True"></asp:RequiredFieldValidator>
							</td>
							<td align="right">
							<asp:DropDownList ID="CountryKey" runat="server"  style="width:105px">
                      <asp:ListItem Value="none">.انتخاب کنید</asp:ListItem>
                      ...
                      <asp:ListItem Value="zwe">Zimbabwe</asp:ListItem>
							...
							<td>&nbsp;</td>
							<td align="left">کشور</td>
						</tr>
						<tr>
							<td align="right" dir="rtl" style="width: 289px">
							<asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="ProvinceKey" ErrorMessage="استان خود را انتخاب کنید." InitialValue="none" SetFocusOnError="True"></asp:RequiredFieldValidator>
							</td>
							<td align="right">
							<asp:DropDownList ID="ProvinceKey" runat="server" CssClass="settings_input" style="width:105px">
                     <asp:ListItem Value="none">.انتخاب کنید</asp:ListItem>
                     ...
                     <asp:ListItem Value="0">کشورم ایران نیست</asp:ListItem>
							...
							<td>&nbsp;</td>
							<td align="left">استان</td>
						</tr>
						<tr>
							<td align="right" dir="rtl" style="width: 289px">
							<asp:RequiredFieldValidator ID="RequiredFieldValidator45" runat="server" ControlToValidate="city" ErrorMessage="شهر خالی است." SetFocusOnError="True"></asp:RequiredFieldValidator>
							</td>
							<td align="right">
							<asp:TextBox ID="city" runat="server" lang="fa" MaxLength="50" style="text-align: right"></asp:TextBox>
							</td>
							<td>&nbsp;</td>
							<td align="left">شهر</td>
						</tr>
						<tr>
							<td align="right" style="width: 289px">&nbsp;</td>
							<td align="right">
							<asp:TextBox ID="url" runat="server" MaxLength="100">http://</asp:TextBox>
							</td>
							<td>&nbsp;</td>
							<td align="left">آدرس وب من</td>
						</tr>
						<tr>
							<td align="right" style="width: 289px">&nbsp;</td>
							<td align="right" dir="rtl">
							<asp:RadioButton id="ShowAgeDisabled" runat="server" cssclass="settings_input" groupname="ShowAgeEnabled" text="فعال" />
							<asp:RadioButton id="ShowAgeEnabled" runat="server" cssclass="settings_input" groupname="ShowAgeEnabled" text="غیر فعال" />
							</td>
							<td>&nbsp;</td>
							<td align="left">نمایش سن</td>
						</tr>
						<tr>
							<td align="right" style="width: 289px">&nbsp;</td>
							<td align="right" dir="rtl">
							<asp:RadioButton id="ShowCityDisabled" runat="server" cssclass="settings_input" groupname="ShowCityEnabled" text="فعال" />
							<asp:RadioButton id="ShowCityEnabled" runat="server" cssclass="settings_input" groupname="ShowCityEnabled" text="غیر فعال" />
							</td>
							<td>&nbsp;</td>
							<td align="left">نمایش شهر</td>
						</tr>
						<tr>
							<td align="right" style="width: 289px">&nbsp;</td>
							<td align="right">
							<asp:TextBox ID="about" runat="server" cols="30" lang="fa" MaxLength="200" rows="5" style="text-align: right;" TextMode="MultiLine"></asp:TextBox>
							</td>
							<td>&nbsp;</td>
							<td align="left">درباره من</td>
						</tr>
						<tr>
							<td align="right" style="width: 289px">&nbsp;</td>
							<td align="right" height="200px" valign="top">
							<asp:Button id="save" runat="server" onclick="save_Click" text="ذخیره" />
							</td>
							<td>&nbsp;</td>
							<td align="left" height="200px">&nbsp;</td>
						</tr>
						<tr>
							<td align="right" class="validation_tahoma" style="width: 289px">
							&nbsp;</td>
							<td align="right" class="validation_tahoma">&nbsp;</td>
							<td>&nbsp;</td>
							<td align="left">&nbsp;</td>
						</tr>
					</table>
			...
			<div id="left_bottom">
				...
				<asp:PlaceHolder ID="SiteFooterSection" runat="server">
				</asp:PlaceHolder>
				</span></div>
		</div>
		<!--/left-->
