<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FilterBySubjectWord.aspx.cs" Inherits="Admin_FilterBySubjectWord" %>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form2" runat="server">
			...
			<asp:button id="_unfilter" style="Z-INDEX: 107; LEFT: 320px; POSITION: absolute; TOP: 312px"
				runat="server" Height="24" Text="Unfilter" Width="64px" OnClick="_unfilter_Click"></asp:button><asp:textbox id="_word" style="Z-INDEX: 102; LEFT: 319px; POSITION: absolute; TOP: 214px" runat="server"></asp:textbox><asp:label id="LabelWord" style="Z-INDEX: 103; LEFT: 212px; POSITION: absolute; TOP: 216px"
				runat="server" Text="New Password :">Word</asp:label><asp:label id="message" style="Z-INDEX: 104; LEFT: 258px; POSITION: absolute; TOP: 143px" runat="server"
