/* All rights reserved to Mr. Alireza Poshtkoohi (C) 2005. alireza_electronics_net@yahoo.com */
var langFarsi = true;
var farsikey = [
...
HTMLArea.Config = function () {
	...
	this.bodyStyle = "background-color: #fff; font-family: Tahoma; font-size:10pt; direction:rtl";
	this.editorURL = "";
	...
	this.btnList = {
		...
		about:          ["about",                "About this editor",  "ed_about.gif",             true],
    		farsi:          ["farsi",         	 "Change Language",    "fa.gif",         	   false],
  	  	dirright:       ["BlockDirRtl",          "Right to Left",      "rtl.gif",		   false],
    		dirleft:        ["BlockDirLtr",          "Left to Right",      "ltr.gif",		   false],		
...
HTMLArea.prototype._buttonClicked = function(txt) {
	...
	switch (cmd.toLowerCase()) {
	    ...
	    case "farsi":
	    	langFarsi = !langFarsi;	 
	    	//var editor1 = this;
	    	//btn1 = editor.config.btnList['farsi'];
	        //langFarsi?document.images.langimg.src="images/fa1.gif":document.images.langimg.src="images/en.gif";
		langFarsi?this.config.btnList["farsi"][2]="images/fa.gif":this.config.btnList["farsi"][2]="images/en.gif";
	        break;     
	    case "help":
