<%@ Page Language="C#" CodeFile="account.aspx.cs" Inherits="bookstore.cp.account"%>
...
<div id="skl">
    ...
    <right>
            <table border="0" cellspacing="4" cellpadding="2" style=" margin-left:100px">
              <tr>
               <td colspan="4" class="validation_tahoma" dir="rtl"> <asp:Label ID="message" runat="server"></asp:Label></td>
              </tr>
                    <tr>
        <td colspan="4">
		<hr/></td>
              ...
              <tr>
                ...
                <td width="10">&nbsp;</td>
                <td width="120">نام و نام خانوادگی</td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td><div align="right">
                    <asp:DropDownList ID="CountryKey" runat="server" style="width:120px;height:25px">
                      ...
                      <asp:ListItem Value="irn">ایران</asp:ListItem>
              ...
              <tr>
                ...
                <td><div align="right">
                    <asp:Button ID="save" runat="server" Text="ذخیره" style="height:20px" 
                        onclick="save_Click"/>      
                </div></td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
